...
mdis <- read.table("2020_가구원_20251107_47184.csv", header=FALSE, sep=",", colClasses = c("character"
...
, "MD제공용_가구고유번호", "MD제공용_가구원고유번호", "가구원정보_성별코드", "가구원정보_만연령", "가구원정보_가구주관계코드", "가구원정보_동거코드", "가구원정보_교육정도_최종학력코드", "가구원정보_교육정도_수학구분코드", "가구원정보_혼인상태코드", "가구원정보_종사상지위코드", "보완_가구원정보_등록장애인여부", "가구원정보_귀화및인지국적취득또는외국인여부")
