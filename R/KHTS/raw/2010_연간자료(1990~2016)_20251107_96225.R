...
mdis <- read.table("2010_연간자료(1990~2016)_20251107_96225.csv", header=FALSE, sep=",", colClasses = c("numeric"
...
, "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric"
, "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric"
, "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "character"), skip=1, na.string=c("*","**","***","****","*****","******","*******","********","*********","**********","."))
...
, "보험", "기타금융", "기타서비스", "비소비지출", "경상조세", "비경상조세", "연금", "사회보장", "이자비용", "가구간이전지출", "비영리단체로이전", "기타지출", "자산변동으로 인한 지출", "부채감소를 위한 지출", "자산이전", "도시구분여부")
