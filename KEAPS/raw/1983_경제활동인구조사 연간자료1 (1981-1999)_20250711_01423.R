...
mdis <- read.table("1983_경제활동인구조사 연간자료1 (1981-1999)_20250711_01423.csv", header=FALSE, sep=",", colClasses = c("character"
, "character", "character", "character", "character", "character", "character", "character", "character", "character", "character", "character", "character", "character", "character", "character", "character", "character", "character", "character"), skip=1, na.string=c("*","**","***","****","*****","******","*******","********","*********","**********","."))
        ...
        mdis$V18<- recode_factor(mdis$V18, '11'="취업자")
        mdis$V18<- recode_factor(mdis$V18, '12'="일시휴직자")
        mdis$V18<- recode_factor(mdis$V18, '21'="신규실업자")
        mdis$V18<- recode_factor(mdis$V18, '22'="전직실업자")
        mdis$V18<- recode_factor(mdis$V18, '31'="구직경험자")
        mdis$V18<- recode_factor(mdis$V18, '32'="6개월내 구직자")
        mdis$V18<- recode_factor(mdis$V18, '33'="6개월내 비구직자")
        mdis$V18<- recode_factor(mdis$V18, '34'="순수비경제활동인구")
